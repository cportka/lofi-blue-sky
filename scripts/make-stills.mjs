...
const STILLS = [
  ['hero.png', 'v8-183', null, 0.4, 640],
  ['billow.png', 'bt-41', 'billow', 0.45, 560],
  ['v0.8-genesis-blocks.png', 'v8-183', null, 0.4, 512],
  ['v0.8-genesis-classic.png', '00f50f353cf56cfa55f3b32404db3196e7cef86e37bd4b0fbca9304a8dd6097f', null, 0.33, 512],
  ['v0.8-squall-waves.png', 'squ-12', 'squall', 0.45, 512],
  ['v0.8-billow-cumulonimbus.png', 'bt-18', 'billow', 0.45, 512],
  ['v0.8-billow-cirrus.png', 'bt-36', 'billow', 0.4, 512],
  ['v0.8-billow-lenticularis.png', 'bt-49', 'billow', 0.4, 512],
];
// filmstrip: one seed, 5 loop moments, stitched horizontally. gal-7 is a 1×1 ORIGIN sky — the
// strip shows the entire frame as ONE pixel journeying through the sunset over the loop.
